    ...
    <div class="container">
      ...
      <form action="../../services/create_question.php" method="POST" enctype="multipart/form-data">
        <div class="mb-4">
          ...
          <input type="text" id="question" name="content" class="form-control required"  placeholder="問題文を入力してください">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <input type="text" id="supplement" name="supplement" class="form-control" placeholder="補足を入力してください">
        </div>
