        ...
        <section class="p-quiz-box js-quiz" data-quiz="${questionNumber}">
            ...
            <ul class="p-quiz-box__answer__list">
              <?php for ($j = 0; $j < 3; $j++) { ?>
                <li class="p-quiz-box__answer__item">
                  <button class="p-quiz-box__answer__button js-answer" data-answer="${answerIndex}" data-correct="<?php print_r($questions[$i]["choices"][$j]["valid"]); ?>">
                    <?= $questions[$i]["choices"][$j]["name"]; ?><i class="u-icon__arrow"></i>
                  </button>
                </li>
              <?php } ?>
            </ul>
          ...
          <?php if ($questions[$i]["supplement"]) { ?>
            <cite class="p-quiz-box__note">
              <i class="u-icon__note"></i><? print_r($questions[$i]["supplement"]) ?>
            </cite>
          <? } ?>
        </section>
      <?php } ?>
